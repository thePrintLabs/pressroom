...
class TPL_Edition
{
	...
	*/
	public function add_publication_metabox_callback() {
		...
		echo '<a id="preview_edition" target="_blank" href="' . TPL_CORE_URI . 'preview/reader.php?edition_id=' . get_the_id() . '" class="button button-primary button-large">' . __( "Preview", "edition" ) . '</a><br/><br/>';
