            ...
            <div class="swiper-wrapper">
                ...
                if ( $posts->have_posts() ):
                    while ( $posts->have_posts() ):
                        ...
                        //else:
                            //$tocItemBg = 'background-image: url(\''.$upload_dir['baseurl'].'/2014/08/Chancellor-George-Osborne.jpg\'); background-position:0 0; background-repeat:no-repeat; background-size:cover;';
                        endif;
                ?>
