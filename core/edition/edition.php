...
class PR_Edition
{
	...
	*/
	public function add_publication_metabox_callback() {
		...
		echo '<a id="publish_edition" target="_blank" href="' . admin_url('admin-ajax.php') . '?action=publishing&edition_id=' . get_the_id() . '&pr_no_theme=true&width=800&height=600&TB_iframe=true" class="button button-primary button-large">' . __( "Packaging", "edition" ) . '</a> ';
